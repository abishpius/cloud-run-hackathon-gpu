...
# Do not inherit the backend's generic SERVICE_NAME from a sourced .env file.
# Use FRONTEND_SERVICE_NAME or --service-name to override this frontend-only name.
SERVICE_NAME="${FRONTEND_SERVICE_NAME:-$DEFAULT_SERVICE_NAME}"
